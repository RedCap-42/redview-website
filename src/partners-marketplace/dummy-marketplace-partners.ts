...
export const DUMMY_PARTNERS: RankedMarketplacePartner[] = [
  {
    ...
    name: 'Atelier Sigma',
    description: `**Senior CRM partner for venture-backed teams, with RedView at the core.**

We migrate startups, scale-ups and investment firms onto RedView and design the RevOps layer around it: data model, pipelines, automations and the integrations that keep everything clean. Five years in, with more than 40 rollouts behind us across France, the UK and the wider EU.

RedView is the foundation. Around it we build modular GTM stacks that are structured, automated and genuinely maintainable, so your team can run them without us in the room.
...
#### Why teams pick us
- 100% focused on RedView and its ecosystem
...
- Open-source-native: we build on the core, not around it`,
    ...
    services: [
      ...
      {
        title: 'Custom RedView development',
        description:
          "Workflows, custom objects and API or SDK integrations built on RedView's open-source core.",
      },
      {
    ...
    portfolio: [
      {
        ...
        title: 'Salesforce to RedView, 22k contacts, zero downtime',
        body: `We restructured a nine-year-old Salesforce org into a clean RedView data model, then cut a 40-person sales team over in a single weekend.
...
- Sequenced outreach synced back into RedView
- Qualified-meeting throughput up across the quarter`,
      ...
      },
      {
        ...
        title: 'Self-hosted RedView for a regulated client',
        body: `Deployed and hardened a self-hosted RedView instance for a private-bank client with strict EU data residency.
    ...
    portfolio: [
      {
        ...
        title: 'Board-ready forecasting on RedView',
...
- Board dashboard wired to live RedView data
- Forecast accuracy improved within one quarter`,
  ...
  },
  {
    ...
    description:
      'Boutique CRM implementer for real-estate workflows and WhatsApp automation, with self-hosted RedView deployments across APAC.',
    ...
    services: [
      ...
      },
      {
        ...
        description:
          'Lead capture and follow-up flows that connect WhatsApp conversations back into RedView.',
      },
    ],
    portfolio: [
      {
        client: 'Harbour Estates',
        title: 'WhatsApp leads into RedView for a property group',
        body: `Connected WhatsApp Business to RedView so inbound property enquiries land as qualified leads automatically.

- WhatsApp conversations synced to contact records
- Agent assignment rules based on listing region
- Response-time SLAs tracked in RedView`,
  ...
  },
  {
    ...
    name: 'Kioko Labs',
    description:
      'Self-hosted RedView deployments and API work for teams across Africa and the Gulf.',
  ...
  },
  {
    ...
    name: 'Tomas Brandt',
    description:
      'Independent RedView consultant, ex-Salesforce admin. Available for short solutioning engagements.',
