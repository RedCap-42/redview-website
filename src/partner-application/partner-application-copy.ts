...
export const PARTNER_APPLICATION_COPY = {
  ...
  fields: {
    ...
    twentyExperience: msg`What you've built in RedView *`,
    ...
    twentyExperienceNotesHint: msg`Describe a real RedView project (customer or internal): who it was for, what you built, and how you used the areas you selected. Min. ${TWENTY_EXPERIENCE_NOTES_MIN_LENGTH} characters.`,
    ...
    twentyExperienceProofLinkHint: msg`Best proof first: a live RedView instance URL, a public repo, or a YouTube link. Loom, Drive and file links are accepted but slower to review.`,
