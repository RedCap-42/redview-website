    ...
    highlights: [
      {
        ...
        description: (
          <Trans>
            Forward shared inboxes such as support@yourcompany.com into RedView
    ...
    highlights: [
      {
        ...
        description: (
          <Trans>
            ...
            you need to ship an app on top of RedView, in one place.
          </Trans>
        ),
    ...
    highlights: [
      {
        ...
        description: (
          <Trans>
            To maintain the simplicity of RedView, we are introducing "Advanced
