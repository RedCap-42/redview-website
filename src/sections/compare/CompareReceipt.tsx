...
const REDVIEW_CARD_ICON = {
  alt: 'RedView plan icon',
...
const CardIcon = styled.div`
  ...
  overflow: hidden;
  position: relative;
  width: ${REDVIEW_CARD_ICON.widthPx}px;
      ...
      <CardsGrid>
        ...
        <CardShell>
          <CardHeader>
            ...
            <CardIcon>
              <NextImage
                alt={REDVIEW_CARD_ICON.alt}
                fill
                sizes={`${REDVIEW_CARD_ICON.widthPx}px`}
                src={REDVIEW_CARD_ICON.src}
              />
            </CardIcon>
          </CardHeader>
          <CardRule />
