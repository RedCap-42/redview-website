...
const HUBSPOT_COMPARISON: CompetitorComparison = {
  ...
  eyebrow: msg`RedView vs HubSpot`,
  heading: msg`What does\n*HubSpot* really cost?`,
  intro: msg`A feature-by-feature price check, with sources.\nMost of what HubSpot gates behind tiers is simply included in RedView.`,
...
const SALESFORCE_COMPARISON: CompetitorComparison = {
  ...
  eyebrow: msg`RedView vs Salesforce`,
  ...
  migrationLine: msg`Import your data and see your own numbers. RedView's importer handles Salesforce exports out of the box.`,
  slug: 'salesforce',
...
const PIPEDRIVE_COMPARISON: CompetitorComparison = {
  ...
  eyebrow: msg`RedView vs Pipedrive`,
  heading: msg`What does\n*Pipedrive* really cost?`,
  intro: msg`A friendly price on the front page.\nThe caps show up after you sign.`,
  migrationLine: msg`Import your data and see your own numbers. Pipedrive exports map cleanly onto RedView objects.`,
  slug: 'pipedrive',
...
const DYNAMICS_COMPARISON: CompetitorComparison = {
  ...
  eyebrow: msg`RedView vs Microsoft Dynamics`,
  ...
  migrationLine: msg`Import your data and see your own numbers. RedView's importer handles Dynamics exports without a consulting project.`,
...
const SAP_COMPARISON: CompetitorComparison = {
  ...
  eyebrow: msg`RedView vs SAP Sales Cloud`,
