...
import { WHY_REDVIEW_HERO } from './why-redview-visual-config';

// The /why-redview hero: a textured backdrop with the halftone model floating
...
export function WhyRedViewVisual() {
  return (
    <VisualFrame aria-hidden>
      ...
      <ForegroundLayer>
        <HalftoneModel
          initialPose={WHY_REDVIEW_HERO.initialPose}
          modelUrl={WHY_REDVIEW_HERO.modelUrl}
          priority
          settings={WHY_REDVIEW_HERO.settings}
        />
      </ForegroundLayer>
    </VisualFrame>
  );
