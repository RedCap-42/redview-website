...
describe('ImportVisual', () => {
  it('renders the imported-data and redview-fields columns', () => {
    renderVisual();

    expect(screen.getByText('Imported data')).toBeInTheDocument();
    expect(screen.getByText('RedView fields')).toBeInTheDocument();
  });
  ...
  it('maps the imported columns onto RedView fields', () => {
    renderVisual();
