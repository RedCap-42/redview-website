      ...
      <Grid>
        ...
        <TextColumn>
          ...
          <Heading size="lg" weight="light">
            {i18n._(msg`How teams\n*explore with RedView*`)}
          </Heading>
          <BodyMeasure>
            <Body muted size="sm">
              {i18n._(
                msg`Meet the teams and athletes who rely on RedView for precision terrain modeling, route simulation, and high-resolution 3D planning.`,
              )}
            </Body>
          </BodyMeasure>
          <Button
