      ...
      <IntroStack>
        <HeadingPair>
          <HeadingMeasure>
            <Heading as="h1" size="lg" weight="light">
              {i18n._(msg`Dernières\n*Mises à jour*`)}
            </Heading>
          </HeadingMeasure>
          <BodyMeasure>
            <Body muted size="sm">
              {i18n._(
                msg`Découvrez les nouvelles fonctionnalités et optimisations de RedView, la plateforme de référence pour l'exploration 3D et le routage extrême.`,
              )}
            </Body>
          </BodyMeasure>
        </HeadingPair>
        <CtaRow>
          <Button
            ...
            label={i18n._(msg`Notes techniques & versions`)}
