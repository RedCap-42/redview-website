...
export const BECOME_PARTNER_FAQ_QUESTIONS: readonly FaqQuestion[] = [
  {
    ...
    answer: msg`Click Become a partner and complete the short application: who you are, what you cover, and one real RedView project with proof. We review every application against real, shipped work — acceptance is selective.`,
  },
  {
    question: msg`What are the requirements?`,
    answer: msg`At least one shipped RedView implementation — customer or internal — with a link that shows the work. Solo freelancers and agencies both qualify.`,
  },
  {
