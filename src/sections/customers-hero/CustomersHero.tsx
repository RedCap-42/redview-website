        ...
        <HeadingPair>
          <HeadingMeasure>
            <Heading as="h1" size="lg" weight="light">
              {i18n._(msg`Découvrez toutes les fonctionnalités\nde *RedView*`)}
            </Heading>
          </HeadingMeasure>
          <BodyMeasure>
            <Body muted size="sm">
              {i18n._(
                msg`L'environnement 3D géospatial le plus précis au monde pour préparer, explorer et sécuriser vos aventures outdoor.`,
              )}
            </Body>
          </BodyMeasure>
        </HeadingPair>
