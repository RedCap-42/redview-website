...
const COMPARE_LINKS = [
  { label: msg`RedView vs HubSpot`, href: '/compare-pricing/hubspot' },
  { label: msg`RedView vs Salesforce`, href: '/compare-pricing/salesforce' },
  {
    label: msg`RedView vs SAP Sales Cloud`,
    href: '/compare-pricing/sap-sales-cloud',
  },
  { label: msg`RedView vs Pipedrive`, href: '/compare-pricing/pipedrive' },
  {
    label: msg`RedView vs Microsoft Dynamics`,
    href: '/compare-pricing/microsoft-dynamics',
  },
  // Attio comparison parked, may return:
  // { label: msg`RedView vs Attio`, href: '/compare-pricing/attio' },
];
